...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0x8F46547B);
  late Color secondary = const Color(0xFFEE7C34);
  late Color tertiary = const Color(0xFFE86969);
  late Color alternate = const Color(0xFFEEE2E2);
  late Color primaryText = const Color(0xFF080809);
  late Color secondaryText = const Color(0xFFEE7C34);
  late Color primaryBackground = const Color(0xFF46547B);
  late Color secondaryBackground = const Color(0xE6E0E3E7);
